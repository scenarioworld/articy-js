declare module 'articy-node/json' {
    ...
    export interface EntityProps extends ArticyObjectProps, DisplayNameProps, ColorProps, PreviewImageProps
    {
    }
    ...
    export interface HubProps extends PinnedObjectProps, DisplayNameProps, TextProps
    {
    }

    /** Base export interface for all flow fragments */
    export interface FlowFragmentProps extends PinnedObjectProps, TextProps, DisplayNameProps, PreviewImageProps
    {
        TechnicalName: string;
        Attachments: Id[];
    }
    ...
    /** Base export interface for all flow fragments */
    export interface DialogueProps extends PinnedObjectProps, TextProps, DisplayNameProps, PreviewImageProps
    {
        TechnicalName: string;
        Attachments: Id[];
    }
    ...
    export interface DialogueFragmentProps extends PinnedObjectProps, TextProps, MenuTextProps
    {
    ...
    export interface FeatureProps { } // eslint-disable-line @typescript-eslint/no-empty-export interface
    ...
    export interface LocationProps extends ArticyObjectProps, TextProps, DisplayNameProps, ColorProps
    {
    ...
    export interface ZoneProps extends ArticyObjectProps, TextProps, ColorProps, DisplayNameProps
    {
    ...
    export interface ModelData<PropertiesType extends ArticyObjectProps = ArticyObjectProps, TemplateType extends TemplateProps = TemplateProps>
    {
        /** Object type */
        Type: string;
