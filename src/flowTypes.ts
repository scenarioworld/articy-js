import { FlowObjectProps, TemplateProps, Id, ConnectionProps, PinProps, PinnedObjectProps, ScriptNodeProps, JumpProps, DialogueFragmentProps, FlowFragmentProps, DialogueProps } from "articy-node/json";
